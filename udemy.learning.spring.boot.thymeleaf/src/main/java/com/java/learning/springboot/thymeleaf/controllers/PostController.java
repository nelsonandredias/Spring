package com.java.learning.springboot.thymeleaf.controllers;
...
import com.java.learning.springboot.thymeleaf.models.Post;

@Controller
@RequestMapping("/posts")
public class PostController {

	//Model class allow us to add attributes and push them to be shown in the view "views/list"
	
	@RequestMapping("/")
    public String list(Model model){
        model.addAttribute("pageTitle","My Thymeleaf page");
    ...
    private ArrayList<Post> createPosts(){
        ...
        post2.setAuthor("Nelson Dias");
        post2.setBody("<p>This is my second post.");
